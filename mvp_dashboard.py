...
from core.ai_mentor import get_mentor_feedback
...
def run_mvp_dashboard():
    ...
    # -----------------------------------------------------------------
    # -----------------------------------------------------------------
    # MAIN LAYOUT: LEFT = Strategy, RIGHT = Run
    # -----------------------------------------------------------------
  ...
  # ---------------- AI MENTOR ----------------
    ...
    mf = st.session_state.get("mentor_feedback")
    if mf:
        st.metric("Readiness", mf["readiness_score"])
        for n in mf["mentor_notes"]:
